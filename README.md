...
--------------------------
Tavastia Events on AvoinHäme-hankkeessa Helsingin kaupungin/6Aika hankkeen kehittämän Linked events-tapahtumarajapinnan muokattu versio. Pääasialliset erot alkuperäiseen toteutukseen ovat käyttäjättömyys ja paikkojen syöttäminen käsin. Tavastia Events on tarkoitettu kaikille, eli kuka tahansa tapahtumajärjestäjä koosta riippumatta, voi syöttää tapahtumansa rajapintaan. 

Tapahtumien muokkaaminen onnistuu tapahtumaan syöttövaiheessa liitetyllä salasanalla. Paikkojen lisääminen onnistuu joko suoraan rajapintaan syöttämällä, tai esimerkiksi käyttämällä yhdessä rajapinnan kanssa kehitettyä tavastiaevents.fi sivustoa.

AvoinHäme-hanke
---------------
AvoinHäme-hankkeen tarkoituksena on lisätä tietoisuutta ja osaamista avoimesta datasta Kanta-Hämeen yrityksissä sekä julkisissa organisaatioissa ja täten luoda edellytyksiä avoimen datan hyödyntämiselle näiden toiminnassa.
...
AvoinHäme-hankkeen kotisivut: https://avoinhäme.fi


# Alkuperäinen Linked events-osuus
...
1. a way to report errors in event data
...
2. a way to report inapproriate event
...
3. a way to request a forgotten password
